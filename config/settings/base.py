...
ROOT_DIR = environ.Path(__file__) - 3  # (c_insta/config/settings/base.py - 3 = c_insta/)
APPS_DIR = ROOT_DIR.path('c_insta')
...
MIGRATION_MODULES = {
    'sites': 'c_insta.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'c_insta.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'c_insta.users.adapters.SocialAccountAdapter'
...
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'c_insta.users.serializers.SignUpSerializer'
}